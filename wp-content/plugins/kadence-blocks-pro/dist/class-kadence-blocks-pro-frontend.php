...
class Kadence_Blocks_Pro_Frontend {
					...
					if ( isset( $match ) && isset( $match[0] ) && !empty( $match[0] ) ) {
						...
						add_action(
							...
							function() use( $modal_content, $unique_id ) {
								...
								echo apply_filters( 'kadence_blocks_pro_modal_footer_output', $modal_content );
								echo '<!-- [/pro-modal-' . esc_attr( $unique_id ) . '] -->';
							},
							9
						);
	...
	public function blocks_modal_array( $attr, $unique_id ) {
		...
		if ( isset( $attr['closeHoverColor'] ) || isset( $attr['closeHoverBackground'] ) ) {
			$css .= '#kt-modal' . $unique_id . ' .kt-modal-close:hover, #kt-target-modal' . $unique_id . ' .kt-modal-close:hover, .kb-modal-content' . $unique_id . ' .kt-modal-close:hover {';
	...
	public function blocks_image_overlay_array( $attr, $unique_id ) {
		$css = '';
		if ( isset( $attr['titleSize'] ) || isset( $attr['titleLineHeight'] ) || isset( $attr['typography'] ) || isset( $attr['letterSpacing'] ) ) {
		...
		if ( isset( $attr['subtitleSize'] ) || isset( $attr['subtitleLineHeight'] ) || isset( $attr['stypography'] ) || isset( $attr['sletterSpacing'] ) ) {
